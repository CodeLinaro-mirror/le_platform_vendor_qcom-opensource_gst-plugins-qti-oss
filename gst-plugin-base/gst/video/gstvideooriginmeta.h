...
GST_API
GType gst_video_origin_meta_api_get_type (void);

GST_API
const GstMetaInfo * gst_video_origin_meta_get_info (void);

GST_API
GstVideoOriginMeta * gst_buffer_add_video_origin_meta (GstBuffer * buffer);

GST_API
GstVideoOriginMeta * gst_buffer_get_video_origin_meta (GstBuffer * buffer);
